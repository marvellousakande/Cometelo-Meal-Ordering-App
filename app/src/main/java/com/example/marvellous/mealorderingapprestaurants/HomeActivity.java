...
import com.example.marvellous.mealorderingapprestaurants.Model.Category;
import com.example.marvellous.mealorderingapprestaurants.ViewHolder.MenuViewHolder;
...
public class HomeActivity extends AppCompatActivity
    ...
    private void showDialog() {
        ...
        categoryName = add_menu_layout.findViewById(R.id.mnu_name);
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Snackbar.make(drawer,"Uploaded", Snackbar.LENGTH_LONG)
                                    .show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Snackbar.make(drawer,""+e.getMessage(), Snackbar.LENGTH_LONG)
                                    .show();
                        }
                    })
